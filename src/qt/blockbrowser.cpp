...
{
    if(Height > pindexBest->nHeight) { return "0x000000a49664091ce50794d84fb243cde97738534b554b2022fa00a029d0ab7c"; }
    if(Height < 0) { return "0x000000a49664091ce50794d84fb243cde97738534b554b2022fa00a029d0ab7c"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " PKB");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " PKB");
    }
}
